...
/// non-whitelisted resources bypasses the proxy) with the option to route all
/// traffic through it. It behaves like a mainstream browser plus private-resource
/// access — not a privacy/anonymity browser. Only whitelisted private resources
/// are tunneled, which is where its access protection applies.
@main
